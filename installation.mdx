---
title: "Install NuvioTV on Android TV"
...
| Flavor | Package ID | Plugin support | In-app updates | Trailers |
|---|---|---|---|---|
| `full` | `com.nuvio.tv` | ✅ Yes | ✅ Yes | ✅ Yes |
| `playstore` | `com.nuvio.app` | ❌ No | ❌ No | ✅ External only |
