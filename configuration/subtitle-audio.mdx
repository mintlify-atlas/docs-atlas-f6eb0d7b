...
description: "Configure subtitle and audio languages, libass rendering, font size, colors, timing offset, and hardware decoder priority in NuvioTV."
---
...
<Tabs>
  ...
  <Tab title="Audio">
    ...
    **Essential + Advanced.** Controls whether NuvioTV prefers the device's hardware decoder or ExoPlayer's software decoder. The value is an integer index:
