---
title: "Media Playback Engines and HDR Support in NuvioTV"
sidebarTitle: "Playback"
description: "NuvioTV uses ExoPlayer and MPV as dual playback engines with automatic failover, Dolby Vision P7-to-P8.1 transcoding, frame-rate matching, and hardware decoder selection."
---
...
| `AUTO` | NuvioTV chooses based on stream type; prefers ExoPlayer, falls back to MPV |
