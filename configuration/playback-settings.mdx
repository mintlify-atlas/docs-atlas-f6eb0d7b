...
description: "Configure NuvioTV's player engine, stream selection, next-episode behavior, P2P streaming, and advanced buffer and decoder options for optimal playback."
---
...
In Essential mode, `EssentialPlaybackSettingsContent` renders two groups. Player preference is **not** surfaced here — it is an Advanced-mode setting.
